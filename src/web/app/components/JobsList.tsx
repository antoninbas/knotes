...
export default function JobsList(props: Props) {
  ...
  const [typeFilter, setTypeFilter] = createSignal<string>("embed");
      ...
      >
        ...
        <div class="flex items-center justify-between px-5 py-4 border-b" style={{ "border-color": "var(--color-border)" }}>
          ...
          <div class="flex items-center gap-3">
            ...
            >
              <option value="embed">All</option>
              <option value="embed:background">Background</option>
              <option value="embed:on-demand">On-demand</option>
            </select>
            <button
              onClick={() => load()}
